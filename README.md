...
Title page details and  `.typ` files to include in document should be specified in `thesis.typ`

Formatting is specified in `cambridge.typ`

References and citation styles are placed in `Referencing` folder
